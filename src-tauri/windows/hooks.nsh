...
!macro NSIS_HOOK_POSTINSTALL
  ...
  WriteRegStr HKCU "Software\Classes\MDViewer.markdown\shell\open" "" "用 MD Viewer 打开"
  ...
  WriteRegStr SHCTX "Software\MD Viewer\Capabilities" "ApplicationName" "MD Viewer"
  WriteRegStr SHCTX "Software\MD Viewer\Capabilities" "ApplicationDescription" "AI Markdown 本地阅读器"
  WriteRegStr SHCTX "Software\MD Viewer\Capabilities\FileAssociations" ".md" "MDViewer.markdown"
  WriteRegStr SHCTX "Software\MD Viewer\Capabilities\FileAssociations" ".markdown" "MDViewer.markdown"
  WriteRegStr SHCTX "Software\RegisteredApplications" "MD Viewer" "Software\MD Viewer\Capabilities"
...
!macro NSIS_HOOK_POSTUNINSTALL
  ...
  DeleteRegValue SHCTX "Software\RegisteredApplications" "MD Viewer"
  DeleteRegKey SHCTX "Software\MD Viewer"
  System::Call 'shell32.dll::SHChangeNotify(i 0x08000000, i 0, i 0, i 0)'
!macroend
